...
def _tema_de(indicador):
    ...
    """
    # "ingreso" y no "apoyos": la página se renombró cuando la beca y la
    # pensión dejaron de ser una sección propia y pasaron a leerse dentro de
    # la composición del ingreso del hogar (ver enigh_ingreso.csv.py).
    return "ingreso" if indicador.startswith("Recibe la ") else "gastos"
